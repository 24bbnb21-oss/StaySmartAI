...
if st.session_state.step == "plan":
    ...
    border-radius:40px;">
        ...
        <br><br>
        Our platform transforms raw employee data into clear risk scores and
        actionable recommendations so HR teams can proactively retain top talent.
        We focus on accuracy, simplicity, and real-world impact for businesses of
        all sizes.
        </p>
    </div>
    """, unsafe_allow_html=True)
...
# All rights reserved
# =========================
st.markdown("<div style='text-align:center;color:#cbd5f5;margin-top:40px;'>© All rights reserved — EXQ-16 team</div>", unsafe_allow_html=True)
